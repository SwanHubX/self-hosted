...
services:
  ...
  swanlab-server:
    <<: *common
    image: ccr.ccs.tencentyun.com/self-hosted/swanlab-server:v3.0.0
  ...
  swanlab-house:
    <<: *common
    image: ccr.ccs.tencentyun.com/self-hosted/swanlab-house:v3.0.0
  ...
  swanlab-cloud:
    <<: *common
    image: ccr.ccs.tencentyun.com/self-hosted/swanlab-cloud:v3.0.0
  ...
  swanlab-next:
    <<: *common
    image: ccr.ccs.tencentyun.com/self-hosted/swanlab-next:v3.0.0
...
if [ ${#NOT_HEALTHY_SERVICES[@]} -ne 0 ]; then
  ...
  exit 1
    ...
    echo "                                              ";
     echo " Self-Hosted Docker v3.0.0 - @SwanLab"
    echo -e "${reset}"
    print_access_urls() {
