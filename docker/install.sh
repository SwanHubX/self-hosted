...
services:
  ...
  swanlab-server:
    <<: *common
    image: repo.swanlab.cn/self-hosted/swanlab-server:v3.2.0
  ...
  swanlab-house:
    <<: *common
    image: repo.swanlab.cn/self-hosted/swanlab-house:v3.2.0
  ...
  swanlab-cloud:
    <<: *common
    image: repo.swanlab.cn/self-hosted/swanlab-cloud:v3.2.0
  ...
  swanlab-next:
    <<: *common
    image: repo.swanlab.cn/self-hosted/swanlab-next:v3.2.0
