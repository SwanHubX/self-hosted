...
> 🤔**如何从旧版本升级**：同步项目仓库后，执行 `cd docker && ./upgrade.sh` 可升级至 `v2.6.2` 版本

**v2.6.2 (2025.12.19)**
- swanlab-server 更新至 v2.6.2
- swanlab-house, swanlab-next, swanlab-cloud 更新至 v2.6.0
