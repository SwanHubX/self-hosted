...
> 🤔**如何从旧版本升级**：同步项目仓库后，执行 `cd docker && ./upgrade.sh` 可升级至 `v2.1` 版本
...
| 私有化版本   | 支持的 SDK 版本 |
|-----------|------------------|
| v2.3    | v0.6.0 ~ latest (除分组功能)    |
| v2.2    | v0.6.0 ~ latest (除分组功能)    |
| v2.1    | v0.6.0 ~ latest (除分组功能)    |
| v2.0    | v0.6.0 ~ latest (除分组功能)    |
| v1.3    | v0.6.0 ~ latest (除分组功能)    |
| v1.2    | v0.6.0 ~ v0.6.4           |
| v1.1    | v0.6.0 ~ v0.6.4           |
