...
images=(
  ...
  "ccr.ccs.tencentyun.com/self-hosted/swanlab-server:v2.6.3"
  "ccr.ccs.tencentyun.com/self-hosted/swanlab-house:v2.6.3"
  "ccr.ccs.tencentyun.com/self-hosted/swanlab-cloud:v2.6.3"
  "ccr.ccs.tencentyun.com/self-hosted/swanlab-next:v2.6.3"
)
