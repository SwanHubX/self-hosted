...
images=(
  ...
  "repo.swanlab.cn/self-hosted/redis-stack-server:7.2.0-v15"
  "repo.swanlab.cn/self-hosted/clickhouse:24.3"
  "repo.swanlab.cn/self-hosted/logrotate:v1"
  "repo.swanlab.cn/self-hosted/fluent-bit:3.1"
  "repo.swanlab.cn/self-hosted/minio:RELEASE.2025-02-28T09-55-16Z"
