...
images=(
  ...
  "ccr.ccs.tencentyun.com/self-hosted/swanlab-server:v2.7.0"
  "ccr.ccs.tencentyun.com/self-hosted/swanlab-house:v2.7.0"
  "ccr.ccs.tencentyun.com/self-hosted/swanlab-cloud:v2.7.0"
  "ccr.ccs.tencentyun.com/self-hosted/swanlab-next:v2.7.0"
)
