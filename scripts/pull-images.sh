...
images=(
  ...
  "ccr.ccs.tencentyun.com/self-hosted/swanlab-house:v2.2"
  "ccr.ccs.tencentyun.com/self-hosted/swanlab-cloud:v2.2"
  "ccr.ccs.tencentyun.com/self-hosted/swanlab-next:v2.2"
)
