...
images=(
  ...
  "ccr.ccs.tencentyun.com/self-hosted/swanlab-server:v2.4"
  "ccr.ccs.tencentyun.com/self-hosted/swanlab-house:v2.4"
  "ccr.ccs.tencentyun.com/self-hosted/swanlab-cloud:v2.4"
  "ccr.ccs.tencentyun.com/self-hosted/swanlab-next:v2.4"
)
