...
images=(
  ...
  "ccr.ccs.tencentyun.com/self-hosted/swanlab-server:v1.3"
  "ccr.ccs.tencentyun.com/self-hosted/swanlab-house:v1.3"
  "ccr.ccs.tencentyun.com/self-hosted/swanlab-cloud:v1.3"
